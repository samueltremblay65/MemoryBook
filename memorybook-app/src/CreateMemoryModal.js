...
export const CreateMemoryModal = ({ onSubmit, onCancel, closeModal }) => {
  ...
  function submitForm()
  {
    ...
    onSubmit(headline, location, date, content, file);
  }
    ...
    >
      <div className="modal padded-modal form-modal">
        ...
        <div className="modal-content">
          ...
          <h3>Headline</h3>
          <input name="headline" id="cm_headline" placeholder="Short description of your memory"></input>

          <h3>Location</h3>
          <input name="location" id="cm_location" placeholder="Where?"></input>

          <h3>Date</h3>
          <input name="location" id="cm_date" placeholder="When?"></input>

          <h3>Content</h3>
          <textarea name="description" id="cm_content" placeholder="Describe this memory"></textarea>

          <h3>Photos</h3>
          <input type="file" id="file_selector" name="file"></input>
